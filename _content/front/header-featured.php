<div id="header-featured" class="carousel slide row" data-ride="carousel">
    ...
    <div id="control-wrapper" class="container">
        <a class="left carousel-control custom-control" href="#header-featured" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control custom-control" href="#header-featured" role="button" data-slide="next">
