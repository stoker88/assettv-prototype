<div id="feature-tabs" role="tabpanel">
    <!-- Nav tabs -->
    <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="mobile-dropdown-toggle">Content<span class="caret"></span></button>
    <ul id="featured-tablist" class="nav nav-tabs nav-justified mobile-dropdown-menu" role="tablist" id="myTab">
