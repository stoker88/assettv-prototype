<div role="tabpanel">
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="latest-content-tab"><?php include "latest-items.php"; ?></div>
    <div role="tabpanel" class="tab-pane" id="trending-tab"><?php include "trending-items.php"; ?></div>
  </div>
